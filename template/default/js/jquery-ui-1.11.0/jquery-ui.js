...
var dialog = $.widget( "ui.dialog", {
	...
	_createTitlebar: function() {
		...
		// dialog in IE (#9312)
		this.uiDialogTitlebarClose = $( "<button type='button'><h2><span class=\"glyphicon glyphicon-remove ui-dialog-titlebar-close \"></span></h2></button>" )
			.button({
			...
			.addClass( "ui-dialog-titlebar-close btn btn-default" )
